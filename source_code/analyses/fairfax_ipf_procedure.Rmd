...
#save file in 
if(!file.exists( paste0("~/git/household_living_budget/documents/products/derived_variables/", name_files, "_", state_name, "_acs_ipf_estimates_2022.csv") )){
  
  write.csv(ipf_full, paste0("~/git/household_living_budget/documents/products/derived_variables/", name_files, "_", state_name, "_acs_ipf_estimates_2022.csv") , row.names = FALSE)
}
