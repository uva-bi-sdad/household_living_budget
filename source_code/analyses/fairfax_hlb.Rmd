...
transp_cost_va <- read_excel("~/git/household_living_budget/data/household_living_budget/transportation/va_tr_cnt_2022_transportation_cost_family.xlsx")
...
#save file in 
if(!file.exists( paste0("~/git/household_living_budget/data/household_living_budget/hlb_estimates/", name_files, "_", state_name, "_cde_hlb_no_tax_2022.csv") )){
  
  write.csv(df_hlb_tic, paste0("~/git/household_living_budget/data/household_living_budget/hlb_estimates/", name_files, "_", state_name, "_cde_hlb_no_tax_2022.csv") , row.names = FALSE)
}
