...
#ggsave("ex6_fairfax_ev_map.pdf", width=10, height=11)
ex6_fairfax_prev_map
...
#ggsave("ex5_fairfax_prev_plot.pdf", width=12, height=10)
ex5_fairfax_prev_plot
